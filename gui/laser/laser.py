...
class LaserGUI(GUIBase):
    ...
    def on_activate(self):
        ...
        # bug in the colorbar displaying.
        ...
        self._mw.channel_ComboBox.currentIndexChanged.connect(self._laser_logic.set_OOP_channel)
        ...
        self._mw.bayopt_channel_ComboBox.currentIndexChanged.connect(self._laser_logic.set_OOP_channel)
